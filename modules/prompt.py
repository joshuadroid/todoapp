...
class Prompt:
    ...
    def __init__(self, submitted_prompts):
        # maps to a dictionary of { "selection number": {"text": "prompt text here", "function" : function here }}
        self.__prompt_map = {}
        current_number = "1"
        for prompt_string in submitted_prompts:
            self.__prompt_map[current_number] = {"text": prompt_string, "function": submitted_prompts[prompt_string]}
